...
Sau khi kết nối xong, tin nhắn khách gửi đến tài khoản LINE của doanh nghiệp sẽ hiện trong [Hộp thư đến (Inbox)](../operations/inbox-usage). Từ đó, nhân viên hoặc [Trợ lý AI](../scaleflow-ai/ai-assistant) có thể trả lời khách ở một chỗ.
...
Nếu bật **Đồng bộ danh bạ**, ScaleFlow sẽ lấy danh sách người **đang theo dõi** Official Account LINE của bạn và thêm vào mục [Liên hệ (Contacts)](../operations/contact-management).
...
3. Nhân viên trả lời trực tiếp, hoặc bật [Trợ lý AI](../scaleflow-ai/ai-assistant) để hỗ trợ trả lời.
4. Nếu cần theo dõi việc xử lý, tạo [Ticket](../operations/ticket-usage) từ hội thoại.
...
1. Thêm câu trả lời mẫu, chính sách, FAQ vào [Knowledge](../scaleflow-ai/knowledge-usage) để AI trả lời chính xác hơn.
2. Thiết lập [AI Agent](../scaleflow-ai/ai-agent-usage) nếu muốn tự động hóa.
3. Bật [Trợ lý AI](../scaleflow-ai/ai-assistant) khi sẵn sàng.

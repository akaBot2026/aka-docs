...
sidebar_position: 3
description: "Akabot Studio のリリース済みバージョンのダウンロード リンク。"
displayed_sidebar: studioSidebar
---

# Akabot Studio — ダウンロード

以下のリンクから Akabot Studio のインストーラーをダウンロードできます。各行は[リリースノート](./release-notes.md) に記載されている公開バージョンに対応しています。変更内容の詳細については、該当するリリースを参照してください。

> **注:** ダウンロード パスワードを取得するには、[サポート チーム](mailto:support@akabot.com) にお問い合わせください。

| バージョン   | ビルド日           | ダウンロード                                                                 |
| ----------- | ----------------- | ----------------------------------------------------------------------------|
| v3.2.4.0    | 2026 年 9 月 18 日 | [ダウンロード](https://ws3.akabot.com/s/yNTrzZuMR12sFVk)                     |
...
| v2.2.0.12   | 2026 年 5 月 25 日 | [ダウンロード](https://ws3.akabot.com/s/JA95evQz7ZOvT4l)                     |
| v2.2.0.11   | 2026 年 4 月 29 日 | [ダウンロード](https://ws3.akabot.com/s/8z0ZSMFVjhzfrNw)                     |
...
| v2.2.0.2    | 2023 年 7 月 24 日  | [ダウンロード](https://ws3.fpt-software.vn/s/S9S2v60JjahYvVr)               |

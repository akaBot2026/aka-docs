...
If you can sign in but cannot see a page, it usually means your role does not include that access yet. Ask your admin to update your role in [User Management](../organization/user-management) or [Roles & Permissions](../organization/roles-permissions).

## What to do next

If you are setting up ScaleFlow for your team, go to [Channel Integration](../channels/channel-integration) next so customer messages can arrive in Inbox.

If you are joining as a support staff member, go to [Inbox Usage](../operations/inbox-usage) to learn how to handle conversations.

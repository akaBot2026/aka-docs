...
- Messages appear in [Inbox](../inbox-usage) — staff reply in one place.
- You can enable [AI Assistant](../ai-assistant) for automatic AI replies.
- You can use [Flows](../flow-usage) to welcome customers, ask about their needs, and route to AI or staff.
...
| (Recommended) [Knowledge](../knowledge-usage) + [AI Agent](../ai-agent-usage) | So AI can answer FAQs on the widget |
...
3. In ScaleFlow, open [Inbox](../inbox-usage).
...
1. Create [Knowledge](../knowledge-usage) (FAQ, policies, and more).
2. Create an [AI Agent](../ai-agent-usage) and Publish it.
3. Go to **AI → Inbox Assistant → Smart Assistant** — select the Agent and enable automatic replies. See [AI Assistant](../ai-assistant).
...
If you need a fixed **welcome → check customer message → call AI** flow, create a [Flow](../flow-usage):
...
- See [AI Assistant](../ai-assistant) — the widget uses the same mechanism as other channels.
...
- [Inbox](../inbox-usage) — reply to customers from the widget
- [AI Assistant](../ai-assistant) — enable automatic AI replies
- [AI Agent](../ai-agent-usage) — create an Agent for the widget
- [Flows](../flow-usage) — automation when messages arrive from Chat Widget

...
3. Connect at least one customer channel in [Channel Integration](../channels/channel-integration), such as Zalo OA or Facebook Messenger.
4. Learn the daily customer workspace in [Inbox Usage](../operations/inbox-usage).
...
3. Smart Assistant creates or suggests a [Ticket](../operations/ticket-usage).

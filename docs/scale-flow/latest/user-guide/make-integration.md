...
See also: [AI Agent Usage](./ai-agent-usage) and [Integration Usage](./integration-usage).
...
6. The agent is attached to [Smart Assistant](./ai-assistant) or an Inbox flow.

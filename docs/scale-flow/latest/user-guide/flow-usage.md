...
- At least **one chat channel** connected (Zalo, Messenger, WhatsApp, and more) — see [Channel Integration](./channel-integration).
- (Recommended) An [AI Agent](./ai-agent-usage) and [Knowledge](./knowledge-usage) if the Flow will use AI or query documents.
...
1. An admin [connects Zalo OA](./zalo/connecting-your-zalo-oa-account).
2. Creates [Knowledge](./knowledge-usage) from a product FAQ file.
3. Creates an [AI Agent](./ai-agent-usage) named `Product Advisor` with that Knowledge.
...
- [AI Agent Usage](./ai-agent-usage) — build AI workers used in the **AI Agent** step
- [Knowledge Usage](./knowledge-usage) — add FAQs and documents for **Query Knowledge**
- [Channel Integration](./channel-integration) — Zalo, Messenger, WhatsApp, and more
- [Inbox Usage](./inbox-usage) — view conversations while Flows run
- [AI Assistant](./ai-assistant) — AI support for staff in Inbox

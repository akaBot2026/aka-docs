...
To set up High-Density Agents on Windows Server machine, please see the [Setting Up Windows Server for High-Density Agents](/docs/agent/latest/installation/high-density-agents.md) and [High-Density Agents Setup](/docs/agent/latest/user-guide/high-density-agents.md)

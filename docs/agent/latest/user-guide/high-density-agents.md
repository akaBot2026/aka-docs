...
To set up High-Density Agents on Windows Server machine, please see the [Setting Up Windows Server for High-Density Agents](https://docs.akabot.com/agent/latest/installation/high-density-agents) and [High-Density Agents Setup](https://docs.akabot.com/agent/latest/user-guide/high-density-agents)

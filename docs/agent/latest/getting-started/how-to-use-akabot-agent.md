---
id: how-to-use-akabot-agent
title: "How to use akaBot Agent"
sidebar_label: "How to use akaBot Agent"
sidebar_position: 2
...
* [Using akaBot Agent](#HUsingakaBotAgent)
* [Configure network setting](#HConfigurenetworksetting)
* [Configure bot setting & connect to Bot Center](#HConfigurebotsetting26connecttoBotCenter)
* [Get processes from akaBot Center or akaBot Studio](#HGetprocessesfromakaBotCenterorakaBotStudio)
* [Control the processes](#HControltheprocesses)
  + [1. Pull new version of a package](#H1.Pullnewversionofapackage)
  + [2. Start a process](#H2.Startaprocess)
  + [3. Stop a process](#H3.Stopaprocess)
...
RCA.Activities.Common.TypeSecureText
...
- **Secure Text (SecureString)** - The secure text to be written in the specified UI element.
...
- **Display Name (String)** - The name of this activity. You can edit the name of the activity to organize and structure your code better.  
  E.g: [3424325] Type Secure Text

**Options**

- **Activate (Boolean)** - Active the control.
- **After I Disabled (Boolean)** - If selected, the simulated type is executed even if the specified UI element is disabled.
- **Click Before Typing (Boolean)** - If selected, the text field is clicked before the text is written.
- **Delay Between Keys (Int32)** - Specified amount of time between keys.
- **Deselect After (Boolean)** - Deselect the text field after amount of time (ms).

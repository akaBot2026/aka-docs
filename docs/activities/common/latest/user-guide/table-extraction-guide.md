...
| **Settings (⚙)**  | Settings button to setting table columns (data type, preview data).                 |

![table-extraction-wizard-indicate-element.png](/static/img/table-extraction-wizard-indicate-element.png)


### 5.1. Selected / Unselected a Column
...
> [!CAUTION]
> Do **not** manually edit `ExtractMetadata` or `TableSettings` unless you fully understand the internal XML structure. Incorrect changes can break the extraction logic.

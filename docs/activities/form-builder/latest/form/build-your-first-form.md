...
2. Add a welcome header using the **Layout** group.
   ...
   b. Drag the [Content](/docs/activities/form-builder/latest/form/components/layout.md#content) component and drop it onto the center canvas. The settings modal will open automatically.
...
3. Add personal detail fields using the **Basic** and **Advanced** groups.
   a. **Full Name Field**:
      * Expand the **Basic** category on the left panel, drag a [Text Field](/docs/activities/form-builder/latest/form/components/basic.md#text-field) component, and drop it onto the canvas.
      * Under the **Display** tab, set the **Label** to `Full Name`.
      * Switch to the **Field Key** tab and set the **Property Name** to `fullName`.
      * Click **Save**.
   b. **Work Email Field**:
      * Expand the **Advanced** category on the left panel, drag an [Email](/docs/activities/form-builder/latest/form/components/advanced.md#email) component, and drop it below the Full Name field.
   ...
   c. **Phone Number Field**:
      * Under the **Advanced** category, drag a [Phone Number](/docs/activities/form-builder/latest/form/components/advanced.md#phone-number) component, and drop it below the Work Email field.
...
4. Add employment detail fields using the **Basic** and **Advanced** groups.
   a. **Department Dropdown**:
      * Under the **Basic** category, drag a [Select](/docs/activities/form-builder/latest/form/components/basic.md#select) component, and drop it below the Phone Number field.
   ...
   b. **Employment Type Selection**:
      * Under the **Basic** category, drag a [Radio](/docs/activities/form-builder/latest/form/components/basic.md#radio) component, and drop it below the Department field.
      ...
      * Click **Save**.
   c. **Start Date Picker**:
      * Under the **Advanced** category, drag a [Date / Time](/docs/activities/form-builder/latest/form/components/advanced.md#date--time) component, and drop it below the Employment Type field.
      * Under the **Display** tab, set the **Label** to `Start Date`.
      * Switch to the **Field Key** tab and set the **Property Name** to `startDate`.
      * Click **Save**.

5. Add a tracking field using the **Data** group.
   a. Expand the **Data** category on the left panel, drag a [Hidden](/docs/activities/form-builder/latest/form/components/data.md#hidden) component, and drop it anywhere on the canvas.
   b. Switch to the **Field Key** tab and set the **Property Name** to `employeeId`.
   c. Click **Save**.
